    ...
    public function index(Request $request)
    {
        if(request()->ajax()){
            ...
            if(!$data->isEmpty()){
                ...
                $output .='
                    <div class="actions">
                        <a  data-id="'.$last_id.'" class="button view-all" id="revies-button" href="#"><span><span>Xem thêm</span></span></a>
                    </div>
                ';
            }else{
                $output .='
                    <div class="actions">
                        <a class="button view-all disabled" id="revies-button" href="#"><span><span>Không có dữ liệu</span></span></a>
                    </div>
                ';
            }
