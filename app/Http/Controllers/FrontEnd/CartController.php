        ...
        if(request()->ajax()){
            ...
            if(Cart::content()->count() > 0){
                ...
                $output_3 .= '
                    ...
                    type="button"><span>Xóa giỏ hàng</span></button>';
                    if(Session::get('coupon')){
                        $output_3 .= '<button class="button btn-update" title="Clear Coupon" id="empty_coupon_button"
                        type="button"><span>Xóa mã giảm giá</span></button>';
                    }
            }else{
                $output .='
                <tr class="first odd">
            ...
            $output_2 .='
                <tr>
                    <td colspan="1" class="a-left"> VAT </td>
                ...
                if(Session::get('coupon')){
                    ...
                    $output_2 .='
                        <tr>
                            <td colspan="1" class="a-left"> Mã giảm giá </td>
                ...
                $output_2 .='
                <tr>
                    <td colspan="1" class="a-left"> Giá bán </td>
