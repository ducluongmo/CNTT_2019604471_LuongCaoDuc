...
class VnpayController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($validator->fails()) {
            $output .='
                <dl>
                    <dt class="complete"> Địa chỉ hóa đơn <span class="separator">|</span> <a
                            href="#">Thay đổi</a> </dt>
                    <dd class="complete">
                        <address>
                            '.Auth::user()->name.'<br>
                    ...
                    <dt class="complete"> Địa chỉ nhận hàng <span class="separator">|</span> <a
                            href="#">Thay đổi</a> </dt>
                    <dd class="complete">
                        <address>
                            '.Auth::user()->name.'<br>
                    ...
                    <dt class="complete">Thành tiền</dt>
                    <dd class="complete">
