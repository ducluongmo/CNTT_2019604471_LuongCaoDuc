                        ...
                        <div class="panel blank-panel">
                            <div class="panel-heading">
                                <div class="panel-options">
                                    ...
                                    <li><a class="nav-link active" href="#tab-1" data-toggle="tab">Danh sách mục hàng</a>
                                         </li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Thông tin danh mục sẽ được lưu trên hệ thống.</small>
                </div>
                <form id="sample_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Tên danh mục <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Biểu tượng <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="action_button" id="action_button" class="ladda-button btn btn-primary"
                            data-style="expand-right">Lưu thay đổi</button>
                    </div>
                </form>
            </div>
        </div>
