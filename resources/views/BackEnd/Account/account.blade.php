            ...
            <div class="modal-dialog">
                <div class="modal-content animated flipInY">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Xoá vĩnh viễn tài khoản khỏi hệ thống.</small>
                    </div>
                    <input type="hidden" name="hidden_id_account" id="hidden_id_account">
                    <div class="modal-body">
                        <p>Bạn có muốn xóa "<span id="body_account"></span>"?</p>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Thông tin của tài khoản sẽ được lưu trên hệ thống.</small>
                    </div>
                    <form id="sample_profile_form" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Cấp bậc <sup class="text-danger">*</sup></label>
                                <div class="col-sm-10">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="ladda-button btn btn-primary update_profile" data-style="expand-right">Lưu thay dổi</button>
                        </div>
                    </form>
                </div>
            </div>
