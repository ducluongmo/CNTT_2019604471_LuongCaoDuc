        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Mã giảm giá mới sẽ được lưu trên hệ thống.</small>
                </div>
                <form id="sample_form" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Số lượng <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Ngày giảm <sup class="text-danger">*</sup></label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Loại <sup class="text-danger">*</sup></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Giảm </label>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
           ...
           $('#add_coupon').click(function(){
                ...
                $('.modal-title').text("Thêm mã giảm giá mới");
                $('#action').val("Add");
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if (response.status == 404) {
                            ...
                            $('#image_show').html('');
                            $('.modal-title').text("Chỉnh sửa mã giảm giá");
                            $('#action').val("Edit");
                        }
                    }
                });
