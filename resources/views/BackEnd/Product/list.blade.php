                            ...
                            <div class="panel-heading">
                                <div class="panel-options">
                                    <ul class="nav nav-tabs">
                                        <li id="li_tab1"><a class="nav-link active" href="#tab-1" data-toggle="tab">Danh sách sản phẩm</a></li>
                                        <li id="li_tab2"><a class="nav-link" href="#tab-2" data-toggle="tab">Thêm sản phẩm</a></li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <tfoot>
                                                    <tr style="text-transform: capitalize;">
                                                        <th><input type="checkbox" id="checkAll_footer"><button
                                                                ...
                                                                data-style="expand-right">Xóa</button></th>
                                                                <th>Tên</th>
                                                         <th>thư viện ảnh</th>
                                                         <th>Hình ảnh</th>
                                                         <th>Số lượng</th>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="ibox" id="ibox2" style="margin-top: 5%;">
                                                        <div
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Tên <sup
                                                        ...
                                                        <div id="data_3"
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Ngày giảm giá</label>
                                                        ...
                                                        <div class="form-group row"><label
                                                                class="col-sm-2 col-form-label">Trạng thái <sup
                                                                    class="text-danger">*</sup></label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group row"><label
                                                                class="col-sm-2 col-form-label">Ảnh</label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Giá <sup
                                                                    class="text-danger">*</sup></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="ibox ">
                                                        <div
                                                            ...
                                                            <label class="font-normal">Mô tả sản phẩm <sup
                                                                    class="text-danger">*</sup></label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 col-sm-offset-2">
                                                    ...
                                                    <button class="btn btn-primary btn-lg ladda-button float-right"
                                                        data-style="expand-right" type="submit">Lưu thay đổi</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
