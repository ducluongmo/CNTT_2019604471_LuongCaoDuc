                ...
                <div class="col-sm-8 input-daterange input-group">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="date_added">Ngày thêm</label>
                ...
                <div class="col-sm-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 col-sm-offset-2" style="margin-left: 31%;">
                            ...
                            <input type="button" class="btn btn-outline btn-success" id="refresh" value="Tải lại" style="width: 170px">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Thông tin của khách mua hàng.</small>
                    </div>
