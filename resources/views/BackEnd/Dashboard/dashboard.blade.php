      ...
      <div class="col-lg-3">
         <div class="ibox ">
            ...
            <div class="ibox-content">
               ...
               <small>Tổng lượt xem sản phẩm</small>
            </div>
         </div>
      </div>
      <div class="col-lg-3">
      ...
      var colorDanger = "#FF1744";
         Morris.Donut({
           ...
           data: [
             ...
             {label:"Đơn hàng", value:<?php echo $dh_count ?>},
             {label:"Khách hàng", value:<?php echo $kh_count ?>},
             {label:"Danh mục", value:<?php echo $dm_count ?>},
             {label:"Thương hiệu", value:<?php echo $th_count ?>},
             {label:"Slide", value:<?php echo $sl_count ?>}
           ]
      });
