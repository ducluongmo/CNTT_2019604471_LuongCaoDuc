...
<head>
    ...
    <title>Winstore - @yield('title')</title>
    ...
    <div id="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
                            <div class="dropdown block-language-wrapper">
                                <a role="button" data-toggle="dropdown" data-target="#"
                                    class="block-language dropdown-toggle" href="#"><img
                                        src="{{ asset('frontend/images/vietnamese.png') }} " alt="Vietnamese">Vietnamese <span
                                        class="caret"></span> </a>
                            ...
                            <div class="dropdown block-currency-wrapper"> <a role="button" data-toggle="dropdown"
                                    data-target="#" class="block-currency dropdown-toggle" href="#"> VND <span
                                        class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a href="#">$ - Dollar</a></li>
                                    <li role="presentation"><a href="#">VND - Dong</a></li>
                                    <li role="presentation"><a href="#">€ - Euro</a></li>
                                </ul>
                            </div>
                            <!-- End Header Currency -->
                            <div class="welcome-msg">Trang web bán điện thoại</div>
                        </div>
                        <!-- Header Top Links -->
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 pull-right hidden-xs">
                            <div class="toplinks">
                                <div class="links">
                                    @if (Auth::user())
                                        <div class="myaccount">
                                            <a title="My Account" href=""><span class="hidden-xs">Tài khoản của tôi</span></a>
                                        </div>
                                    @endif
                                    ...
                                    <div class="dropdown block-company-wrapper hidden-xs">
                                        <a role="button" data-toggle="dropdown" data-target="#"
                                            class="block-company dropdown-toggle" href="#"> Xem thêm <span
                                                class="caret"></span>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li role="presentation"><a href=""> Về Winstore </a></li>
                        ...
                        <div class="top-cart-contain" id="top-cart-contain">
                            ...
                            <div class="mini-cart">
                                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle">
                                    <a href="{{ route('cart.index') }}"><span class="price hidden-xs">Giỏ hàng</span>
                                    ...
                                    <div class="top-cart-content" id="top-cart-content">
                                        ...
                                        <div class="actions">
                                            <button class="btn-checkout" title="Checkout" type="button">
                                                @if (Auth::user())
                                                    <a style="color: #fff;"
                                                        href="{{ route('cart-address.index') }}"><span>Thanh toán</span></a>
                                                @else
                                                    <a style="color: #fff;"
                                                        href="{{ route('login.index') }}"><span>Thanh toán</span></a>
                                                @endif
                                            </button>
                                            <a href="{{ route('cart.index') }}" class="view-cart"><span>Xem giỏ hàng</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-4">
                        <div class="mega-container visible-lg visible-md visible-sm">
                            <div class="navleft-container">
                                ...
                                <h3><i class="fa fa-navicon"></i>Danh mục hàng</h3>
                                </div>
                                            ...
                                            <li class="{{ count($childrencate) > 0 ? '' : 'nosub' }}">
                                                ...
                                                @if (count($childrencate) > 0)
                                                    <div class="wrap-popup">
                                                        <div class="popup">
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-6 menu-popup">
        ...
        <footer class="footer">
                                ...
                                <form>
                                    ...
                                    <h4><span>bản tin</span></h4>
                                         <input type="text" placeholder="Nhập địa chỉ email của bạn"
                                             ...
                                             tên="email">
                                         <button class="btn-register" title="Đăng ký"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <h4>Chính sách</h4>
                                 <ul class="links">
                                     <li><a href="login.html" title="Tài khoản của bạn">Chính sách đổi trả</a></li>
                                     <li><a href="#" title="Information">Chính sách thanh toán</a></li>
                                     <li><a href="#" title="Addresses">Chính sách khuyến mãi</a></li>
                                     <li><a href="#" title="Addresses">Chính sách bảo mật</a></li>
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <div class="contacts-info">
                                <div class="address-footer">
                                     <i class="add-icon">&nbsp;</i>255 Lạch Tray, Ngô Quyền,</br>
                                     &nbsp;Thành phố Hải Phòng
                                </div>
                                <div class="phone-footer"><i class="phone-icon">&nbsp;</i> 0936661054
                                </div>
                                <div class="email-footer"><i class="email-icon">&nbsp;</i> <a
                                         href="mailto:abc@magikcommerce.com">winstore@gmail.com</a> </div>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                    <div class="col-sm-5 col-xs-12 coppyright"> &copy; {{ now()->format('Y') }} Winstore
