        ...
        <div class="container">
            <div class="row">
                            ...
                            <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                                <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                                    ...
                                    <div class="item"> <a href="#"><img alt=""
                                                src="{{ asset('frontend/images/slider-iphone15.png') }}"></a>
                                     ...
                                     <!-- Mục -->
                                    <div class="item"><a href="#"><img alt=""
                                    src="{{ asset('frontend/images/slider-samsung.png') }}"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <aside class="col-left sidebar col-md-3 col-sm-4 col-xs-12 col-sm-pull-8 col-md-pull-9">
                    <div class="side-banner"><img src="{{ asset('frontend/images/side-banner-1.png') }}" alt="banner">
                    </div>
                    ...
                    <div class="custom-slider-wrap">
                     ...
                     <div class="block-list block-viewed">
                         ...
                         <div class="block-content">
                             <ol id="recently-viewed-items">
                                 <li class="item lẻ">
                                     <p class="product-name"><a href="#">Ipad Air 5</a></p>
                                 </li>
                                 <li class="item chẵn">
                                     <p class="product-name"><a href="#">Điện thoại Samsung Galaxy Fold</a></p>
                                 </li>
                                 <li class="mục lẻ cuối cùng">
                                     <p class="product-name"><a href="#">Đồng hồ thông minh</a></p>
                                 </li>
                             </ol>
                         </div>
                     </div>
                     <div class="block block-poll">
                        ...
                        <form id="pollForm" action="#" method="post" onSubmit="return validatePollAnswerIsSelected();">
                            <div class="block-content">
                                <p class="block-subtitle">Bạn thấy dịch vụ của chúng tôi như thế nào?</p>
                                <ul id="poll-answers">
                                    <li class="odd">
                                    <input type="radio" name="vote" class="radio poll_vote" id="vote_5" value="5">
                                         <span class="label">
                                             <label for="vote_5">Hài lòng</label>
                                         </span>
                                     </li>
                                     <li class="even">
                                         <input type="radio" name="vote" class="radio poll_vote" id="vote_6" value="6">
                                         <span class="label">
                                             <label for="vote_6">Khá hài lòng</label>
                                         </span>
                                     </li>
                                     <li class="lẻ">
                                         <input type="radio" name="vote" class="radio poll_vote" id="vote_7" value="7">
                                         <span class="label">
                                             <label for="vote_7">Tệ</label>
                                         </span>
                                     </li>
                                     <li class="chẵn cuối cùng">
                                         <input type="radio" name="vote" class="radio poll_vote" id="vote_8" value="8">
                                         <span class="label">
                                             <label for="vote_8">Rất tệ</label>
                                         </span>
                                     </li>
                                 </ul>
                                 <div class="actions">
                    ...
                    <div class="hot-banner"><img alt="banner"
                            src="{{ asset('frontend/images/summer.png') }}"></div>
                </aside>
