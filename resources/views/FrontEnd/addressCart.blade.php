                                            ...
                                            <div class="table-responsive">
                                                <fieldset class="multiple-checkout shipping">
                                                    ...
                                                    <div class="form-group form-list cartvnpay display">
                                                        <label class="required" for="card">Ngân hàng <em>*</em></label>
                                                    ...
                                                    <div class="buttons-set">
                                                        <a href="{{ url()->previous() }}" class="back-link"><small>« </small>Quay lại Trang chủ</a>
                                                        <button class="button btn-continue" title="Xác nhận thanh toán"
                                                            type="submit"><span>Xác nhận thanh toán</span>
                                                        </button>
