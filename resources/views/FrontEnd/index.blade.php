...
<div class="container">
    <div class="row">
        <div class="col-md-3 col-md-4 col-sm-3 hidden-xs">
            <div class="side-banner"><img src="{{ asset('frontend/images/side-banner-1.png') }}"
                    alt="banner"></div>
        </div>
                ...
                <div class="promotion-banner">
                    <div class="row">
                        <div class="col-lg-5 col-sm-5">
                            <a href="#"><img alt=""
                                    src="{{ asset('frontend/images/home-banner.png') }}"></a>
                        </div>
                        <div class="col-lg-7 col-sm-7">
                            <a href="#"><img alt=""
                                    src="{{ asset('frontend/images/home-banner2.jpg') }}"></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="navbar nav-menu">
                            <div class="navbar-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a data-toggle="tab" href="#tab-31">ipad</a></li>
                            ...
                            <div id="testimonials-slider"
                                ...
                                <div class="slider-items slider-width-col4 fadeInUp">
                                    ...
                                    <div class="holder">
                                        ...
                                        <p>Nhân viên phục vụ rất tận tâm và nhiệt tình, họ đã giúp tôi tìm kiếm những chiếc điện thoại phù hợp với gu thẩm mỹ của mình. Đặc biệt, dịch vụ giao hàng nhanh chóng và đáng tin cậy.</p>
                                        <div class="line"></div>
                                    ...
                                    <div class="holder">
                                        <div class="thumb"> <img
                                                ...
                                                alt="testimonials img"> </div>
                                        <p>Tôi muốn chia sẻ rằng tôi đã có một trải nghiệm mua sắm tuyệt vời tại shop điện thoại này. Những mẫu điện thoại tại đây không chỉ đa dạng về kiểu dáng mà hiệu năng cũng rất đỉnh.</p>
                                        <div class="line"></div>
                                    ...
                                    <div class="holder">
                                        <div class="thumb"> <img
                                                ...
                                                alt="testimonials img"> </div>
                                        <p>Nhân viên đã tư vấn rất tận tâm, giúp tôi chọn lựa được chiếc tai nghe phù hợp với nhu cầu sử dụng của bản thân...</p>
                                        <div class="line"></div>
