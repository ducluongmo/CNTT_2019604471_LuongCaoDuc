                                ...
                                <form method="post" id="formCart">
                                    ...
                                    <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                                        ...
                                        <div class="ratings">
                                            ...
                                            @endif
                                            <p class="rating-links"> <a href="#">{{ count($review) }} Đánh giá</a> <span
                                                    class="separator">|</span> <a href="#">Thêm đánh giá</a> </p>
                                        </div>
                                        ...
                                        <div class="add-to-box">
                                            <div class="add-to-cart">
                                                <div class="pull-left">
                                                    <div class="custom pull-left"> <span class="qty-label">SLG:</span>
                                                        <button
