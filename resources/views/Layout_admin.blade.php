        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="text-muted text-xs block">Quản lý cửa hàng<b class="caret"></b></span>
                        </a>
                        <ul class="menu thả xuống hoạt hình fadeInRight m-t-xs">
                            <li><a class="dropdown-item" id="edit_profile" data-profile_id="{{ Auth::user()->id }}" >Sửa hồ sơ</a></li>
                            <li><a class="dropdown-item" href="{{ route('contacts.index') }}">Liên lạc</a></li>
                ...
                <li class="{{ route('dashboard.index')==$url_canonical ? 'active' : '' }}">
                    <a href="{{route('dashboard.index')}}"><i class="fa fa-th-large"></i> <span class="nav-label">Bảng thống kê</span></a>
                </li>
                ...
                >
                    <a href="#"><i class="fa fa-inbox"></i> <span class="nav-label">Quản lý sản Phẩm</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li  class="{{ route('product.index')==$url_canonical || route('product-gallery.index')==$url_canonical  ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-inbox"></i> <span class="nav-label">Quản lý sản phẩm</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li  class="{{ route('product.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('product.index') }}">Danh sách sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-certificate"></i> <span class="nav-label">Quản lý danh mục</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('category.index') }}">Danh sách mục hàng</a></li>
                ...
                <li class="{{ route('slider.index')==$url_canonical ? 'active' : '' }}">
                    <a href=""><i class="fa fa-slideshare"></i> <span class="nav-label">Quản lý slide </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('slider.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('slider.index') }}">Danh sách slide</a></li>
                        @if (route('slider.index')==$url_canonical)
                            <li><a id="add_slider">Thêm slide</a></li>
                        @endif
                    </ul>
                </li>
                <li class="{{ route('coupon.index')==$url_canonical ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-files-o"></i> <span class="nav-label">Quản lý mã giảm giá</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('coupon.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('coupon.index') }}">Liệt kê mã giảm giá</a></li>
                        @if (route('coupon.index')==$url_canonical)
                        <li><a id="add_coupon">Thêm mã giảm giá</a></li>
                        @endif
                    </ul>
                </li>
                <li class="{{ route('order.index')==$url_canonical ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-files-o"></i> <span class="nav-label">Quản lý đơn đặt hàng</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('order.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('order.index') }}">Danh sách đơn đặt hàng</a></li>
                    </ul>
                </li>
                 <li class="landing_link">
                    <a target="_blank" href="{{ route('home') }}"><i class="fa fa-star"></i> <span class="nav-label">Quay lại trang mua sắm</span></a>
                </li>
            </ul>
